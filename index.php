...
<head>
  ...
  <!-- Pick Date CSS -->
  <link href="vendor/jquery/css/default.css" rel="stylesheet">
  <link href="vendor/jquery/css/default.date.css" rel="stylesheet">
  <!--[if lt IE 9]>
        ...
        <div class="col-md-4 mb-3 mb-md-0">
          <div class="card py-4 h-100">
            <div class="card-body text-center">
              ...
              <h4 class="text-uppercase m-0">WORLD BOXING COUNCIL</h4>
              <hr class="my-4">
              <div class="small text-black-50">Riobamba 835, Mexico City,Mexico, 07300</div>
            </div>
          </div>
        </div>
          ...
          <div class="card py-4 h-100">
            <div class="card-body text-center">
              ...
              <div class="small text-black-50">
                <a href="mailto:membership@wbcboxing.com">membership@wbcboxing.com</a>
              </div>
            </div>
          </div>
        </div>
