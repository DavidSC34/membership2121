...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top"> <img src="img/Header-01.png" class="img-fluid" alt=""> </a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#about">Benefits</a>
          </li>
          <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#" target="_blank" data-toggle="modal" data-target="#loginModal">Log In</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <header class="masthead">
    <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
        <h1 class="mx-auto my-0 ">Be Part Of The Family</h1>
        <h2 class="text-white mx-auto mt-2 mb-5">WBC is Hope and Glory.<br/>Join the boxing membership.</h2>
          ...
          <div class="col-lg-6">
            <div class="card mb-5 mb-lg-0">
              <div id="green-benefits" class="card-body text-white">
                <!-- <h5 class="card-title text-muted text-uppercase text-center">Welcome Kit</h5> -->
                <h6 class="card-price text-center">GREEN<span class="period"></span></h6>
                <hr>
                <ul class="fa-ul">
           ...
           <div class="col-lg-6">
            <div class="card mb-5 mb-lg-0">
              <div id="gold-benefits" class="card-body">
               <!--  <h5 class="card-title text-muted text-uppercase text-center">Welcome Kit</h5> -->
                <h6 class="card-price text-center">GOLD<span class="period"></span></h6>
                <hr>
                <ul class="fa-ul">
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>WBC Card(ID)</li>
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>T-Shirt</li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-8 mx-auto text-center">
          ...
          <h2 class="text-black mb-5">Fill the form to receive benefits!</h2>
                    ...
                    <div class="form-group">
                      <label for="membresiaInput">Membership Type</label>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="membership" id="membership" value="GREEN">
                            <label class="form-check-label" for="membershipRadios">
                              GREEN
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="membership" id="membership" value="GOLD" >
                            <label class="form-check-label" for="membershipRadios">
                              GOLD
                            </label>
                          </div>
      ...
      <div id="pago-paypal-green" class="container" style="display: none">
          <div class="row">
                  <div class="col-md-12 col-lg-8 mx-auto text-center">
                     <h2 class="text-black mb-5">Green Membership Paypal Payment</h2>
      ...
      <div id="pago-paypal-gold" class="container" style="display: none">
          <div class="row">
                  <div class="col-md-12 col-lg-8 mx-auto text-center">
                     <h2 class="text-black mb-5">Gold Membership Paypal Payment</h2>
                     <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        <input type="hidden" name="cmd" value="_s-xclick">
  ...
  <!-- Contact Section -->
  <section id="contact-us" class="contact-section bg-black">
    <div class="container">
        ...
        <div class="col-md-4 mb-3 mb-md-0">
          <div class="card py-4 h-100">
            <div class="card-body text-center">
              ...
              <hr class="my-4">
              <div class="small text-black-50">835 Riobamba, CDMX MX</div>
            </div>
          </div>
        </div>
          ...
          <div class="card py-4 h-100">
            <div class="card-body text-center">
              ...
              <div class="small text-black-50">
                <a href="#">membership@wbcboxing.com</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-3 mb-md-0">
          <div class="card py-4 h-100">
            <div class="card-body text-center">
              ...
              <hr class="my-4">
              <div class="small text-black-50">+52 555119-5274</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="social d-flex justify-content-center">
        <a href="https://twitter.com/WBCBoxing" class="mx-2">
          <i class="fab fa-twitter"></i>
        </a>
        <a href="https://www.facebook.com/WBCBOXING/" class="mx-2">
          <i class="fab fa-facebook-f"></i>
        </a>
        <a href="http://www.youtube.com/wbcboxingvid/" class="mx-2">
          <i class="fab fa-youtube"></i>
        </a>
        <a href="http://www.instagram.com/wbcboxing/" class="mx-2">
